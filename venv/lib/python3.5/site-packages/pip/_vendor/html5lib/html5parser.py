...
from .constants import (
    spaceCharacters, specialUpper2Lower,
...
def getPhases(debug):
    ...
    class InitialPhase(Phase):
        ...
        def processDoctype(self, token):
            ...
            if publicId != "":
                publicId = publicId.translate(specialUpper2Lower)
        ...
        def startTagMeta(self, token):
            ...
            if self.parser.tokenizer.stream.charEncoding[1] == "tentative":
                if "charset" in attributes:
                    ...
                    # to be encoded and as a special-superset works.
    ...
    class InBodyPhase(Phase):
        ...
        def startTagInput(self, token):
            ...
            if ("type" in token["data"] and
                    token["data"]["type"].translate(specialUpper2Lower) == "hidden"):
        ...
        def startTagIsIndex(self, token):
            ...
            if "prompt" in token["data"]:
                ...
                prompt = "This is a searchable index. Enter search Keyword: "
    ...
    class InForeignContentPhase(Phase):
        ...
        def processEndTag(self, token):
            ...
            if node.name.translate(specialUpper2Lower) != token["name"]:
                self.parser.parseError("unexpected-end-tag", {"name": token["name"]})
